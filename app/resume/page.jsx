...
const experience = {
  ...
  title: "My Experience",
  description:
    "Huge love for programming, learning new technologies and mastering them. And I love crafting ideas in reality",
  items: [
    {
      company: "GCIT,RUB",
      position: "Student",
      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <div className="min-h-[70vh] w-full">
                  ...
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                    {experience.items.map((item, index) => {
                      return (
                        <li
                          key={index}
                          className="bg-[#eceae9] h-[184px] py-6 px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1"
                        >
            ...
            >
              <div className="flex flex-col group-[30px]:">
                <h3 className="text-4xl font-bold">{about.title}</h3>
                <p className="max-w-[600px] text-black/80 mx-auto xl:mx-0 mb-4">
                  {about.description}
                </p>
